...
@Component({
    ...
    standalone   : true,
    imports      : [FuseLoadingBarComponent, NgIf, FuseVerticalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, FuseFullscreenComponent, SearchComponent, MessagesComponent, UserComponent, FuseHorizontalNavigationComponent, RouterOutlet],
})
