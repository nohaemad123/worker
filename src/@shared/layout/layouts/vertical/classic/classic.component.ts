...
import { BreadcrumbsComponent } from '@shared/layout/common/breadcrumbs/breadcrumbs.component';
...
@Component({
    ...
    standalone   : true,
    imports      : [FuseLoadingBarComponent, FuseVerticalNavigationComponent, MatButtonModule, BreadcrumbsComponent, MatIconModule, LanguagesComponent, FuseFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, NgIf, RouterOutlet],
})
