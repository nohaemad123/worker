...
@Component({
  selector: 'app-detailed-commissions-reports',
  templateUrl: './detailed-commissions-reports.component.html',
  styleUrl: './detailed-commissions-reports.component.scss'
})
export class DetailedCommissionsReportsComponent implements OnInit {
  ...
  getAllReportsList(): void {
    ...
    this._basicService
      .getAll(ENDPOINT.DETAILED_COMMISSIONS, this.filterCriteria)
  ...
  onPrintReport(): void {
    this._basicService
      .get(ENDPOINT.COMMISSION_REPORT + '/CommotionOrderReport', {
